...
const NUM_BOTS = 10; // Scalable to 100
...
async function run() {
  ...
  // Wait a moment for all bots to connect and receive initial state
  ...
  if (MODE === 'race') {
    ...
    console.log(`Firing bids of amount ₹${amount.toLocaleString()}...`);
    bots.forEach((bot, i) => {
